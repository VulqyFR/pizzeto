...
export const Hero = () => {
    return (
        <section className="w-full py-32 xl:py-20 mb-16">
            <div className="relative flex flex-col xl:flex-row items-center justify-between">
                <div className="xl:mb-24 flex flex-col gap-4 flex-1 items-center xl:items-start text-center md:text-left relative z-10 px-4">
                    ...
                    <p className="max-xl:text-center text-md sm:text-md md:text-lg text-foreground font-semibold max-w-sm max-lg:max-w-xs mt-2 mb-6">
                ...
                <div className="max-xl:relative h-[825px] w-[825px] absolute z-50 xl:-top-36 -right-12 flex justify-center md:justify-end items-center pointer-events-none max-xl:-ml-56 2xl:-mr-12 xl:-mr-40">
                    <Image
